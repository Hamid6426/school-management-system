...
const AdminNavbar = () => {
  ...
  const navItems = [
    ...
    {
      button: 'Reports',
      links: [{ label: 'Attendance Report', href: '/admin-dashboard/attendance-report' }],
    },
    {
      button: 'Announcements',
      links: [{ label: 'Create Announcement', href: '/admin-dashboard/create-announcement' }],
    },
    {
      button: 'Settings',
      links: [{ label: 'Admin Settings', href: '/admin-dashboard/admin-settings' }],
    },
  ];

  return (
    <div className="d-flex flex-column p-3 bg-white bg-black0 text-whites" style={{ width: '240px', height: '100vh' }}>
      <h4 className="text-primary mb-3 text-center fw-bold h4">PROGRESS SCHOOL</h4>
