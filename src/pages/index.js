...
export default function Home() {
  return (
    <div
      className="bg-black1 text-black text-whites min-vh-100 w-100 d-flex flex-row align-items-center justify-content-center position-relative"
      ...
      <div className="d-flex flex-row justify-content-center align-items-center w-100 pt-5 gap-5">
        <div className="d-flex flex-column justify-content-center align-items-center">
          <div className="d-flex flex-column justify-content-center align-items-start text-weight-bold">
            ...
            <h1 style={{ fontSize:"2rem", fontWeight:"bold"}} className="mb-4">System</h1>
            <GetStarted/>
          </div>
        </div>
